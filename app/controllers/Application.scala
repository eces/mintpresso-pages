  ...
  def javascriptRoutes = Action { implicit request =>
    ...
    Ok(
      Routes.javascriptRouter("routes")(
        ...
        routes.javascript.Pages.pickupList,
        routes.javascript.Pages.pickupListPause,
        routes.javascript.Pages.pickupListStart,
        routes.javascript.Pages.pickupAdd,
        routes.javascript.Pages.pickupAddUpdate,
